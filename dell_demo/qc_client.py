...
class QcClient(object):
    ...
    def __init__(self, project="371612180_DEMO"):
        ...
        self.session.headers.update({'Host': 'login.software.microfocus.com'})
